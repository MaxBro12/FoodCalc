...
#### Запуск только бэкенда приложения

Если для простого тестирования или просмотра возможностей приложения в `.env` файле установите переменную `USE_LOCAL=True`. Так внешние запросы к другим сервисам не будут вызываться, а будут предоставлены mock данные.
